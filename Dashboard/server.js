...
function postRequests(request, response)
{
  ...
  if (pathname == "/login")
  {
    ...
    request.on('data', function(chunk) {
      ...
      AWS.config = {
        accessKeyId:'AKIAJY2GFAYI6ZEVH7PQ',//'AKIAJGXOI72NFIJEBT6Q',
		secretAccessKey:'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',//'y+9PrREorrAfC74nzEkDmvOd/R9J6rZEfF81nhPL',
        region: 'us-west-2',
        sslEnabled: true
      }
...
https.createServer(options, OnRequest).listen(4430);

http.createServer(OnUnsecuredRequest).listen(8088);

console.log("Secure HTTPS server running on port 4430");
ClearExpiredTokens();
