...
var express = require('express')
  ...
  , http = require('http')
  , path = require('path')
  , cloud_res_monitor = require('./routes/cloud_res_monitor');
...
app.get('/vendor_addsensors', function(req,res){res.render('../views/vendor_addsensors.ejs');});
...
app.get('/cloud_res_monitor', cloud_res_monitor.render);//New Cloud resource
